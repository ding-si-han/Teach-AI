    ...
    <div>
      ...
      <GridContainer>
        <GridItem xs={12} sm={12} md={12}>
          <Card profile>
            ...
            <CardHeader color="primary">
              <h2 className={classes.cardTitleWhite}>VEDANT SAHAI</h2>
            ...
            <CardBody profile style={{ marginTop: "0px" }}>
              ...
              <p className={classes.description}>
                Vedant is a noisy student with good grades. He is very vocal in
                class. <br />
                Vedant interacts with almost everyone, and enjoys coding.
              </p>
        ...
        <GridItem xs={12} sm={12} md={6}>
          <Card profile>
            <CardHeader color="primary">
              <h3 className={classes.cardTitleWhite}>CODING</h3>
              <h6
                className={classes.cardCategoryWhite}
                style={{ fontWeight: "500" }}
              >
            ...
            <CardBody profile style={{ marginTop: "0px" }}>
              ...
              <p className={classes.description}>
                <br />
                SOME INSIGHTS ABOUT CODING TO BE FILLED.
              </p>
              <Button color="primary" round>
                PRINT CODING
              </Button>
