...
export function makePoseDetectionDriver(_a) {
    ...
    return function (params$) {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, setupCamera(document.querySelector("#" + videoID), videoWidth, videoHeight)];
                            case 1:
                                video = _b.sent();
                                video.play();
        ...
        var vdom$ = xs.of((Snabbdom.createElement("div", { id: divID, style: { position: "relative" } },
            Snabbdom.createElement("video", { id: videoID, style: { display: 'none' }, autoPlay: true }),
            Snabbdom.createElement("canvas", { id: canvasID }))));
        return {
            DOM: adapt(vdom$),
            poses: adapt(poses$),
        };
