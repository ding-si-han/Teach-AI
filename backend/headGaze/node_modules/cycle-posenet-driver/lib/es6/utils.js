...
export function drawSegment(_a, _b, color, scale, ctx) {
    var ay = _a[0], ax = _a[1];
    var by = _b[0], bx = _b[1];
    ctx.beginPath();
...
export function drawKeypoints(keypoints, minConfidence, ctx, scale) {
    if (scale === void 0) { scale = 1; }
...
export var setupCamera = function (video, videoWidth, videoHeight) { return __awaiter(_this, void 0, void 0, function () {
    var mobile, stream;
