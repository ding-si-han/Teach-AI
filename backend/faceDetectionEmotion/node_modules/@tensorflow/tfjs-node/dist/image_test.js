    ...
    it('decode png', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    uint8array = _c.sent();
                    return [4 /*yield*/, tf.node.decodePng(uint8array)];
                case 2:
                    imageTensor = _c.sent();
    ...
    it('decode png 1 channels', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    uint8array = _c.sent();
                    return [4 /*yield*/, tf.node.decodeImage(uint8array, 1)];
                case 2:
                    imageTensor = _c.sent();
                    expect(imageTensor.dtype).toBe('int32');
    ...
    it('decode png 3 channels', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    uint8array = _c.sent();
                    return [4 /*yield*/, tf.node.decodeImage(uint8array)];
                case 2:
                    imageTensor = _c.sent();
                    expect(imageTensor.dtype).toBe('int32');
                    expect(imageTensor.shape).toEqual([2, 2, 3]);
    ...
    it('decode png 4 channels', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    uint8array = _c.sent();
                    return [4 /*yield*/, tf.node.decodeImage(uint8array, 4)];
                case 2:
                    imageTensor = _c.sent();
                    expect(imageTensor.dtype).toBe('int32');
    ...
    it('decode bmp', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    uint8array = _c.sent();
                    return [4 /*yield*/, tf.node.decodeBmp(uint8array)];
                case 2:
                    imageTensor = _c.sent();
                    expect(imageTensor.dtype).toBe('int32');
                    expect(imageTensor.shape).toEqual([2, 2, 3]);
    ...
    it('decode jpg', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    uint8array = _c.sent();
                    return [4 /*yield*/, tf.node.decodeJpeg(uint8array)];
                case 2:
                    imageTensor = _c.sent();
                    expect(imageTensor.dtype).toBe('int32');
                    expect(imageTensor.shape).toEqual([2, 2, 3]);
    ...
    it('decode jpg 3 channels', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    uint8array = _c.sent();
                    return [4 /*yield*/, tf.node.decodeImage(uint8array, 3)];
                case 2:
                    imageTensor = _c.sent();
                    expect(imageTensor.dtype).toBe('int32');
                    expect(imageTensor.shape).toEqual([2, 2, 3]);
    ...
    it('decode jpg with downscale', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    uint8array = _c.sent();
                    return [4 /*yield*/, tf.node.decodeJpeg(uint8array, 0, 2)];
                case 2:
                    imageTensor = _c.sent();
                    expect(imageTensor.dtype).toBe('int32');
    ...
    it('decode gif with no expandAnimation', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    uint8array = _c.sent();
                    return [4 /*yield*/, tf.node.decodeImage(uint8array, 3, 'int32', false)];
                case 2:
                    imageTensor = _c.sent();
                    expect(imageTensor.dtype).toBe('int32');
                    expect(imageTensor.shape).toEqual([2, 2, 3]);
    ...
    it('throw error if request non int32 dtype', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    uint8array = _a.sent();
                    return [4 /*yield*/, tf.node.decodeImage(uint8array, 0, 'uint8')];
                case 2:
                    _a.sent();
                    done.fail();
                    return [3 /*break*/, 4];
